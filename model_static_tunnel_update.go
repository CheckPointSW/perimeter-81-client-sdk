...
type _StaticTunnelUpdate StaticTunnelUpdate
...
func (o *StaticTunnelUpdate) UnmarshalJSON(data []byte) (err error) {
	varStaticTunnelUpdate := _StaticTunnelUpdate{}

	err = json.Unmarshal(data, &varStaticTunnelUpdate)

	if err != nil {
		return err
	}

	*o = StaticTunnelUpdate(varStaticTunnelUpdate)
