...
Testing StandardPrivateDNSAPIService
...
func Test_perimeter81sdk_StandardPrivateDNSAPIService(t *testing.T) {
	...
	t.Run("Test StandardPrivateDNSAPIService GetStandardNetworkPrivateDNS", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var networkId string

		resp, httpRes, err := apiClient.StandardPrivateDNSAPI.GetStandardNetworkPrivateDNS(context.Background(), networkId).Execute()
	...
	t.Run("Test StandardPrivateDNSAPIService GetStandardRegionPrivateDNS", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.StandardPrivateDNSAPI.GetStandardRegionPrivateDNS(context.Background(), networkId, regionId).Execute()
