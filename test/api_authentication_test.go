...
func Test_perimeter81sdk_AuthenticationAPIService(t *testing.T) {
	...
	t.Run("Test AuthenticationAPIService AuthorizeToken", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AuthenticationAPI.AuthorizeToken(context.Background()).Execute()
