...
func Test_perimeter81sdk_FirewallPolicyAPIService(t *testing.T) {
	...
	t.Run("Test FirewallPolicyAPIService GetGranularFirewallPolicy", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var networkId string

		resp, httpRes, err := apiClient.FirewallPolicyAPI.GetGranularFirewallPolicy(context.Background(), networkId).Execute()
	...
	t.Run("Test FirewallPolicyAPIService UpdateGranularFirewallPolicy", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var networkId string

		resp, httpRes, err := apiClient.FirewallPolicyAPI.UpdateGranularFirewallPolicy(context.Background(), networkId).Execute()
