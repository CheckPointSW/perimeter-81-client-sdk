...
type _DynamicTunnelDetailsUpdate DynamicTunnelDetailsUpdate
...
func (o *DynamicTunnelDetailsUpdate) UnmarshalJSON(data []byte) (err error) {
	varDynamicTunnelDetailsUpdate := _DynamicTunnelDetailsUpdate{}

	err = json.Unmarshal(data, &varDynamicTunnelDetailsUpdate)

	if err != nil {
		return err
	}

	*o = DynamicTunnelDetailsUpdate(varDynamicTunnelDetailsUpdate)
