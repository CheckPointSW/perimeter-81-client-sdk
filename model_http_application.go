...
// checks if the HttpApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpApplication{}

// HttpApplication struct for HttpApplication
type HttpApplication struct {
	...
	Users []BasicApplicationAllOfUsersInner `json:"users,omitempty"`
	// List of IDs of assigned groups
	Groups []BasicApplicationAllOfGroupsInner `json:"groups,omitempty"`
...
type _HttpApplication HttpApplication
...
func (o *HttpApplication) GetUsers() []BasicApplicationAllOfUsersInner {
	if o == nil || IsNil(o.Users) {
		var ret []BasicApplicationAllOfUsersInner
		return ret
	}
	return o.Users
}
...
// SetUsers gets a reference to the given []BasicApplicationAllOfUsersInner and assigns it to the Users field.
...
func (o *HttpApplication) GetGroups() []BasicApplicationAllOfGroupsInner {
	if o == nil || IsNil(o.Groups) {
		var ret []BasicApplicationAllOfGroupsInner
		return ret
	}
	return o.Groups
}
...
// SetGroups gets a reference to the given []BasicApplicationAllOfGroupsInner and assigns it to the Groups field.
...
func (o HttpApplication) MarshalJSON() ([]byte, error) {
...
func (o HttpApplication) ToMap() (map[string]interface{}, error) {
...
func (o *HttpApplication) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpApplication := _HttpApplication{}

	err = json.Unmarshal(data, &varHttpApplication)

	if err != nil {
		return err
	}

	*o = HttpApplication(varHttpApplication)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "displayIconAtLogin")
...
type NullableHttpApplication struct {
	value *HttpApplication
	isSet bool
}

func (v NullableHttpApplication) Get() *HttpApplication {
	return v.value
}

func (v *NullableHttpApplication) Set(val *HttpApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpApplication(val *HttpApplication) *NullableHttpApplication {
	return &NullableHttpApplication{value: val, isSet: true}
}

func (v NullableHttpApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
