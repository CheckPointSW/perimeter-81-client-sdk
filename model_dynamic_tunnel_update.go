...
func (o *DynamicTunnelUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDynamicTunnelUpdate)
	...
	*o = DynamicTunnelUpdate(varDynamicTunnelUpdate)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "addTunnels")
		delete(additionalProperties, "updateTunnels")
		delete(additionalProperties, "removeTunnels")
		delete(additionalProperties, "sharedSettings")
