...
type _HttpAttributes HttpAttributes
...
func (o *HttpAttributes) UnmarshalJSON(data []byte) (err error) {
	varHttpAttributes := _HttpAttributes{}

	err = json.Unmarshal(data, &varHttpAttributes)

	if err != nil {
		return err
	}

	*o = HttpAttributes(varHttpAttributes)
