...
type _ApplicationsListPaginatedResponse ApplicationsListPaginatedResponse
...
func (o *ApplicationsListPaginatedResponse) UnmarshalJSON(data []byte) (err error) {
	varApplicationsListPaginatedResponse := _ApplicationsListPaginatedResponse{}

	err = json.Unmarshal(data, &varApplicationsListPaginatedResponse)

	if err != nil {
		return err
	}

	*o = ApplicationsListPaginatedResponse(varApplicationsListPaginatedResponse)
