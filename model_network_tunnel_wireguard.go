...
func (o *NetworkTunnelWireguard) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNetworkTunnelWireguard)
	...
	*o = NetworkTunnelWireguard(varNetworkTunnelWireguard)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "leftAllowedIP")
		delete(additionalProperties, "leftEndpoint")
		delete(additionalProperties, "vault")
		delete(additionalProperties, "requestConfigToken")
